...
bool etoile(int(func)(struct parser_s *, void*), void *, struct parser_s *p);
bool plus(int(func)(struct parser_s *, void*), void * ,struct parser_s *p);
bool interrogation(int(func(struct parser_s *, void*)), void *,
    struct parser_s *p);
